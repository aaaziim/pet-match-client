...
const [isRegisterModalOpen, setIsRegisterModalOpen] = useState(false);
    ...
    return (
      <div className='shadow-md rounded-lg p-2 sticky top-0 z-50'>
  ...
  <div className='navbar'>
    <div className="flex items-center space-x-4 w-full px-6">
      <div className="relative flex items-center border border-gray-300 rounded-md flex-grow">
        <svg xmlns="http://www.w3.org/2000/svg" className="absolute left-3 w-5 h-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-4.35-4.35M10 16a6 6 0 100-12 6 6 0 000 12z" />
        </svg>
        <input type="text" placeholder="Search..." className="px-10 py-2 w-full focus:outline-none focus:ring-2 focus:ring-indigo-500" />
        <button className="px-4 py-2 bg-indigo-500 text-white rounded-r-md hover:bg-indigo-600 focus:outline-none">
          Search
        </button>
      </div>
